...
# If/when we have better macro support (i.e. efi-srpm-macros), use %%{efi} here
...
%build
%make_build LIBDIR=%{_libdir} BINDIR=%{_bindir}

%install
%make_install LIBDIR=%{_libdir} BINDIR=%{_bindir}
%if %{with abicheck}
...
%changelog
* Thu Feb 08 2024 Dan Streetman <ddstreet@ieee.org> - 38-9
